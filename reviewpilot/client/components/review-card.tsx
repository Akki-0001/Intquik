        ...
        <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start gap-4 shrink-0 self-stretch md:self-auto pt-1 md:pt-0">
          ...
          {!review.reply && !isReplying && (
            <button
              ...
              className="bg-slate-50 border-none shadow-[0_4px_20px_rgba(26,31,92,0.08)]/80 hover:bg-slate-100 text-[11px] font-bold px-3 py-1.5 rounded-[14px] text-blue-800 flex items-center gap-1.5 transition-all hover:scale-[1.02] active:scale-[0.98] md:mt-4 shadow-sm"
            >
        ...
        <div className="bg-slate-50/50 border-none shadow-[0_4px_20px_rgba(26,31,92,0.08)]/40 rounded-[14px] p-4 mt-4 space-y-3.5 shadow-inner">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-[10px] font-bold text-[#14142B] bg-blue-650 hover:bg-blue-700 px-3 py-1.5 rounded-lg transition-all shadow-md shadow-blue-500/10 active:scale-95 flex items-center gap-1"
            >
          ...
          <div className="flex justify-end gap-2.5">
            ...
            <button
              ...
              className="bg-blue-600 text-[#14142B] text-[10px] font-bold px-4 py-2 rounded-[14px] hover:bg-blue-700 flex items-center gap-1.5 shadow-md shadow-blue-500/10 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
